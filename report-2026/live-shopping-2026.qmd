...
abstract: |
  ...
  lower and bottomed in mid-2024. It then inflected: average monthly search interest
  rose roughly 39% in 2025, with a sustained step-up that began in Q4 2024 - around the
  US TikTok ban drama - and held a structurally higher plateau into 2026. This report builds
  live-shopping and live-selling search indices from a fresh pull of ~80,000 keywords (Google
  Ads Keyword Planner, June 2022 - May 2026, US only) and examines the category from many
  angles: a platform-rotation and share-of-search view, the rise (and fall) of category-native
  challengers, the collectibles-led vertical story, a lead-lag test showing sellers move first,
  and an empirical
  look at trust ("is it legit?") and how the category's questions are maturing. A note on
  method: isolated one-month spikes in individual keywords (a known Keyword-Planner bucketing
  artefact) are rationalized before any index is summed, so the trends here are not driven by
...
- **The category broke out in 2025.** Average monthly US search interest across a basket of
  196 live-shopping queries rose about **39% in 2025 versus 2024** (from roughly 5,810 to
  8,080 indexed monthly searches), after two years of post-Meta decline that bottomed in
  mid-2024.

- **The breakout is a sustained step-up, not a one-month flash.** Interest inflected in **Q4
  2024** and built through **spring 2025** (the smoothed index peaked around May 2025 at ~1.7x
  the June-2022 baseline), overlapping the US TikTok ban drama. Crucially it did not revert: it
  settled onto a structurally higher plateau through 2025 and into 2026. (An apparent
  single-month "January 2025 spike" in an earlier cut turned out to be a data artefact in one
  keyword; see the box on rationalizing spikes.)
...
- **Collectibles still lead, but the mix is broadening.** Trading cards / breaks have the
  deepest, fastest-growing live-shopping vocabulary (+86% over the window, after rationalizing
  one-month spikes), while Whatnot's own reporting shows beauty, electronics, jewelry and
  women's fashion as its fastest-growing GMV categories.
...
1. The much-cited **"January 2025 spike" was largely a data artefact** - one keyword
   (*tiktok live shopping*) jumped a single bucket for one month; rationalizing it dissolves
   the spike and reveals the real story.
2. The genuine signal is a **sustained Q4-2024 step-up** that held into 2026 - a regime change,
   not a flashbulb. Distinguish a one-month anomaly from a durable floor.
3. **Live-selling search leads live-shopping search by ~6 months** (r ≈ 0.5) - a usable leading indicator.
...
12. **Trading-card search has the deepest live-shopping vocabulary and grew +86%, but beauty
    leads the GMV growth** (+791% on Whatnot) - the on-ramp and the money are different verticals.
...
2. **The inflection (late 2024 - spring 2025).** Interest turned up in Q4 2024 and built
   through the first half of 2025, with the smoothed index **peaking around May 2025**. The
   US TikTok ban saga of January 2025 sits inside this window and clearly added fuel - but the
   move is a broad, multi-month step-up, not a single-month event spike (an earlier cut showed
   an outsized January reading that proved to be a one-keyword data artefact; see the box
   below).
...
3. **A higher plateau (2025 - 2026).** Crucially, interest did **not** revert to the 2024
   ...
   towering over the old baseline. Average monthly interest in 2025 was about **39% above
   2024**, and the 2026 months so far sit higher still.
...
| Jan 2025 | US TikTok ban drama + brief outage | Added fuel to the Q4-2024 inflection |
...
## Why we don't trust single-month spikes

An earlier cut of this index appeared to show a dramatic **single-month spike in January 2025**,
which is tempting to read as the TikTok-ban shock made visible. On inspection it was mostly a
**measurement artefact.** Google's Keyword Planner reports monthly volumes in coarse buckets, so
a single keyword can jump several buckets for one month and then fully revert. Here, essentially
the entire apparent January spike came from **one keyword** - *tiktok live shopping* - reading
**390 in December, 6,600 in January, and 260 in February.** A 17x one-month round-trip in a
single term is not credible demand; it is the bucketing in action.

Because the index is a *sum* across the basket, one such artefact can manufacture a category-wide
"event." So we now **rationalize isolated one-month spikes before summing any index**: a month is
capped only when it is both a sharp local outlier (several times its neighbouring months) *and*
large relative to the keyword's own typical level. Genuine sustained rises and recurring seasonal
peaks - whose neighbouring months are also elevated - are left untouched, and broad market-wide
moves that lift many keywords together survive. The procedure touched roughly 5,000 keywords
(about 8,000 month-cells of ~3.8 million) and changed no headline conclusion except to **dissolve
the phantom January spike.**

The payoff is a more honest picture (@fig-index): the breakout is a **broad Q4-2024-to-spring-2025
step-up** that holds into 2026, not a one-month flashbulb. The TikTok ban still sits inside that
window and plausibly added fuel - but the durable signal is the rising *baseline*, which is
exactly what survives once the artefacts are removed. The lesson for reading any summed search
index: a spike in one keyword for one month is almost always noise; trust the floor, not the flash.
...
deal-hunting peak) and a broad **late-winter/spring** plateau (roughly February-April).

![Average search-interest index by calendar month. Live shopping is elevated across the holiday quarter and a late-winter/spring window; the summer dip is shallow.](figures/fig_seasonality.png){#fig-seasonality width=92%}

Two points make this more interesting than a simple "holidays are big" story. First, the
profile is **flatter than expected for a gifting category** - April is actually the single
highest month and the spring window rivals December, which is consistent with live shopping
becoming a year-round habit rather than a purely holiday-driven one. (Once the one-month
January-2025 artefact is rationalized away, January is just an ordinary winter month, not a
spike.) Second, the summer trough (June-September) is shallow and rising year on year. For
sellers and platforms, the practical read is that the calendar still rewards a Q4 push, but the
off-season floor is where the structural growth is showing up.
...
|---|---:|:-:|
| tiktok shop seller center | 18,100 | ↑ |
| how to sell on tiktok shop | 4,400 | ↑ |
| how to sell on whatnot | 2,900 | ↑ |
| whatnot seller fees | 1,600 | ↑ |
| how to start a tiktok shop | 1,000 | → |
| whatnot seller | 880 | → |
| how to start selling on whatnot | 260 | → |
...
| qvc | 3,350,000 | ↓ |
| hsn | 1,000,000 | ↓ |
| qvc com official site | 201,000 | ↑ |
| qvc live | 40,500 | ↓ |
| qvc tv live | 40,500 | ↓ |
| hsn official site | 9,900 | ↑ |
| qvc com official site shopping online | 12,100 | ↑ |
| hsn app | 2,400 | → |
...
lanes**. The table below maps the main players by the **role they play in the market** - grouped
into discovery funnels, category-native destinations, re-platforming incumbents, and the
challenger/toolkit fringe - with their model, lead verticals, and a plain-language read on where
each sits in the search data. The **trend** column is the quick takeaway: who is rising, who is
steady, and who is fading.

| Role | Platform | Model | Lead vertical(s) | Search trend |
|---|---|---|---|---|
| **Discovery funnel** | TikTok Shop | Social feed + live | Beauty, fashion, gadgets | Dominant; moves with news |
| | YouTube Shopping | Creator + shoppable video | Broad, creator-led | Emerging |
| | Amazon Live | Influencer streams + catalogue | Broad consumer goods | Steady, low LS-specific |
| **Category-native destination** | Whatnot | Live marketplace + auctions | Collectibles, now beauty/fashion | Strongest grower (~7x) |
| | Fanatics Live | Live + card breaks | Sports cards, collectibles | Rising |
| | eBay Live | Live auctions | Cards, watches, handbags | Rising; expanding geos |
| | Palmstreet | Live marketplace | Plants, ceramics, niche | Breakout from ~zero |
| **Re-platforming incumbent** | QVC / HSN | Broadcast + streaming + social | Beauty, fashion, home, jewelry | Huge base; re-platforming |
| **Challenger / fringe** | StockX Live | Live drops + auctions | Sneakers, apparel, cards | Launches summer 2026 |
| | NTWRK | Celebrity drops | Streetwear, sneakers | Faded from 2023-24 peak |
| | TalkShopLive | Host-driven shoppable shows | Books, celebrity, CPG | Niche, partnership-led |
| | Popshop (CommentSold) | Live marketplace + SMB tooling | SMB retail, fashion | Consolidating |

: The US live-shopping field, grouped by market role. Read the trend column first: TikTok Shop owns discovery, Whatnot leads the destinations, QVC/HSN is re-platforming a huge legacy base, and the challenger fringe is a mix of newcomers and fade-outs. {#tbl-platforms tbl-colwidths="[20,17,24,24,15]"}
...
1. **Whatnot** - the brand and its long tail (*whatnot app*, *whatnot com*, *whatnot shop*,
   *whatnot seller fees*).
...
The question queries are a window into the category's psychology. The "trust" questions now
dominate - "*is whatnot legit*", "*is tiktok shop legit*" - capturing a platform going
mainstream: as new buyers arrive, they ask whether they can trust it before they commit.
(We exclude "*what is a whatnot*" here: at ~22,000 searches a month it is large, but "a whatnot"
is also a common piece of furniture - a tiered display stand - so the term is too ambiguous to
read as live-shopping intent.)

| Keyword | Avg. monthly searches | 4-yr trend |
|---|---:|:-:|
| is whatnot legit | 14,800 | ↑ |
| is tiktok shop legit | 5,400 | ↑ |
| what is qvc | 4,400 | → |
| is whatnot app legit | 1,300 | ↑ |
| how does tiktok shop work | 1,000 | → |

: Sample of question queries. {#tbl-questions tbl-colwidths="[58,24,18]"}
...
| whatnot app | 90,500 | ↑ |
| hsn app | 2,400 | → |
| live shopping platform | 1,900 | ↑ |
| livestream shopping app | 1,300 | → |
| live stream shopping platform | 1,300 | → |
...
|---|---:|:-:|
| whatnot card | 480 | → |
| whatnot sports cards | 390 | → |
| live sports card breaks | 320 | → |
| card breaks live | 320 | → |
...
trust ("is it legit") questions, while bare "what is it" awareness queries have dwindled to a
few hundred. This is the signature of a maturing market: the centre of gravity has shifted from
*understanding* live shopping to *participating* in it - how to sell, how to use the apps, how to
get started. The awareness phase is essentially over. The two phases that remain live -
participation ("how") and trust ("is it legit") - are the two that platforms can most directly
influence, and they are the subject of the next two sections.
...
cards and "breaks"** have the deepest and fastest-growing vocabulary - dozens of distinct,
intent-rich terms that grew ~86% over the window, the single clearest vertical signal. (Two
caveats on magnitude. First, the raw bucket total is *not* a clean cross-vertical ranking: the
card vocabulary is captured by ~40 specific keywords while other verticals contribute only a
handful, so any direct "X times larger than the next vertical" comparison mostly reflects how
finely each category is enumerated, not true relative demand. Second, the card-break terms are
small and spiky - several individual keywords showed implausible 20-30x one-month jumps. After
rationalizing those bucketing artefacts, the vertical's growth comes down from a raw ~135% to
the ~86% we report.) What is robust is the *depth and momentum* of the vocabulary: this is the
cultural engine that built Whatnot, Fanatics Live and eBay Live, and it remains the gateway
drug into live shopping.
...
|---|---:|:-:|
| live auction | 40,500 | ↓ |
| ebay live auction | 2,900 | ↑ |
| live auction sites | 2,400 | ↑ |
| live auction app | 720 | → |
| whatnot live auction | 390 | → |
| live bidding | 260 | → |
...
- **Spike rationalization:** Keyword Planner volumes are reported in coarse buckets, so an
  individual keyword can jump several buckets for a single month and then fully revert. These
  isolated one-month spikes are artefacts, not demand, and they distort summed indices and
  per-vertical totals. Before any index is built, each keyword's monthly series is passed through
  a despiking filter that caps a month only when it is **both** a sharp local outlier (at least
  ~4x its larger neighbouring month) **and** large relative to the keyword's own non-zero median
  (at least ~5x). The cap is set to roughly twice the neighbouring month. Sustained rises and
  recurring seasonal peaks (whose neighbours are also elevated) and broad market-wide moves
  (which lift many keywords together) are preserved; only egregious single-keyword, single-month
  artefacts are tamed. About 5,000 keywords (~8,000 of ~3.8M month-cells) were touched. The most
  consequential effect was dissolving an apparent January-2025 index spike that was driven almost
  entirely by one keyword.
- **Exclusions:** known bot-inflated terms are removed; international markets are out of scope.
  The term *what is a whatnot* is dropped from every index, trend and table because "a whatnot"
  is also a common piece of furniture (a tiered display stand), making the query too ambiguous to
  treat as live-shopping intent.
...
*Reproducible code and data pipeline on GitHub:
[github.com/papageorgiou/livestream-shopping-research](https://github.com/papageorgiou/livestream-shopping-research)
(the 2026 edition lives in `pipeline-2026/` and `report-2026/`).*
