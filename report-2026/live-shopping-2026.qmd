...
- **Collectibles still lead, but the mix is broadening.** Trading cards / breaks dominate
  live-shopping vertical search (+86% over the window, after rationalizing one-month spikes),
  while Whatnot's own reporting shows beauty, electronics, jewelry and women's fashion as its
  fastest-growing GMV categories.
...
12. **Trading cards lead live-shopping vertical search (+86%), but beauty leads the GMV growth**
    (+791% on Whatnot) - the on-ramp and the money are different verticals.
...
| **Category-native destination** | Whatnot | Live marketplace + auctions | Collectibles → beauty/fashion | Strongest grower (~7x) |
...
cards and "breaks"** dominate vertical search interest and grew ~86% over the window - still the
single clearest vertical signal, and far larger than any other vertical. (An important caveat on
magnitude: the card-break vocabulary is full of small, spiky terms - several individual
keywords showed implausible 20-30x one-month jumps. After rationalizing those bucketing
artefacts, the vertical's growth comes down from a raw ~135% to ~86%, which is the figure we
report. The trading-card lead is real, but it was being overstated by single-month spikes.)
This is the cultural engine that built Whatnot, Fanatics Live and eBay Live, and it remains the
gateway drug into live shopping.
