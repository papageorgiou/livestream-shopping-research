...
abstract: |
  ...
  the commercial value advertisers place on each audience, a device-mix read, and an empirical
...
# Fifteen things that surprised us
...
4. **Whatnot is under-monetised by advertisers**: ~$0.99 median top-of-page bid despite the
   largest consumer audience.
5. The **most valuable keywords are seller/business terms** (*tiktok shop partner center*),
   bidding up to **$148** - the B2B goldmine is the TikTok Shop seller ecosystem.
6. **QVC/HSN is the most mobile audience of all (~71%)** - more phone-first than TikTok or
   Whatnot.
7. **15,000+** QVC/HSN keywords surfaced organically - the "home shopping vs. live shopping"
   academic distinction has collapsed in practice.
8. QVC/HSN's **legacy terms decline while "official site"/app terms rise** - the audience is
   migrating screen-to-screen, not disappearing.
9. **NTWRK collapsed ~96%** from its peak - hype-driven drops are rented; community is owned.
10. **Palmstreet** (live plant/ceramics selling) broke out from near-zero in mid-2024 - the
    new-entrant pipeline is open.
11. The US wave is **home-grown**: interest in Chinese super-apps (Douyin, Taobao Live) is
    negligible as *shopping* intent.
12. **"How do I do it" now outranks "what is it" and "is it legit"** - the market has shifted
    from awareness to participation.
13. The category is **rotating, not consolidating** - the concentration index rose only mildly.
14. **Brand search is escaping the category vocabulary** - people search "whatnot," not
    "whatnot live shopping."
15. **Trading cards lead live-shopping vertical search, but beauty leads the GMV growth** (+791%
...
# The economics of attention: who advertisers actually pay for

Search interest measures consumer attention. But the Keyword Planner also reports what
**advertisers** are willing to pay to intercept each query - the top-of-page bid and competition
index - which is a direct read on the *commercial value* of an audience. Here the data delivers
one of the report's most counter-intuitive findings.

![Median Google top-of-page bid for each platform's live-shopping keywords. Higher = advertisers compete harder to reach that audience.](figures/fig_commercial.png){#fig-commercial width=92%}

**Whatnot has the audience but not the ad prices.** Despite commanding by far the most consumer
search, Whatnot's live-shopping keywords carry a **median top-of-page bid of just ~$0.99** -
the *lowest* of any major platform. eBay (~$8.11) and Facebook (~$10.40) command roughly ten
times more; TikTok sits in between (~$4.27). Three readings, all interesting:

- **Whatnot is under-monetised by the search-ad market** - a possible arbitrage for marketers
  who want a highly engaged audience without paying highly competitive keyword prices, and a
  reminder that Whatnot's own take-rate model (not search ads) is where its value sits.
- **The B2B goldmine is the TikTok Shop *seller* ecosystem.** The single most expensive
  live-shopping keywords are not consumer terms at all - they are seller/business terms like
  *tiktok shop partner center*, *tiktok shop for business* and *tiktok shoppable videos*, with
  top-of-page bids reaching **$80-$148.** An entire economy of agencies, software and services
  is bidding to reach TikTok Shop sellers.
- **The consumer category is still cheap.** A median top-of-page bid of ~$3 and a median
  competition index of ~12 (out of 100) across live-shopping keywords means this is, in
  advertising terms, still an *early* market - attention is growing faster than the cost of
  buying it.

| Keyword | Avg. monthly searches | Top-of-page bid |
|---|---:|---:|
| tiktok shoppable videos | 110 | $148.04 |
| tiktok shop partner center | 880 | $112.09 |
| tiktok shop for business | 390 | $89.88 |
| tiktok shop partnership | 390 | $82.55 |
| seller center tiktok shop | 110 | $74.78 |
| tiktok shop fulfillment | 590 | $57.10 |

: The most commercially valuable live-shopping keywords are seller/business terms, not consumer ones. {#tbl-cpc tbl-colwidths="[54,24,22]"}

# A phone-first behaviour - and a surprise about who is most mobile

Live shopping is, unsurprisingly, a mobile behaviour: across all live-shopping queries,
**~67% of searches come from phones**, versus ~30% desktop and ~3% tablet (@fig-device). What
*is* surprising is the ranking. The most mobile audience of all belongs to **QVC/HSN (~71%
mobile)** - the 40-year-old television brands - while the **collectibles platforms (Fanatics
Live ~59%, eBay ~62%) skew the most desktop.**

![Share of search by device, by platform. Live shopping is phone-first everywhere; QVC/HSN is the most mobile, collectibles platforms the most desktop.](figures/fig_device.png){#fig-device width=100%}

The collectibles skew makes sense: card and watch buyers do real research - comparing
populations, prices and grades - and that research-heavy behaviour pulls toward the desktop.
QVC/HSN's extreme mobile skew is the more telling number: it confirms that the legacy networks'
*search* audience is not sitting in front of a TV with a laptop, but reaching for a phone -
exactly the audience their streaming-and-social pivot is chasing. For platform and ad design,
the implication is blunt: **the experience has to be built phone-first, and the "lean-back TV"
mental model is obsolete even for the brands that invented it.**
...
**Other attention signals agree.** The prior edition noted that Whatnot's rise was mirrored in
YouTube search, Reddit activity, and Wikipedia pageviews - all "up and to the right." The same
holds for the category broadly: live-shopping subreddits have grown, creator content
...
- **Build phone-first, always.** Two-thirds of search is mobile, and even QVC/HSN's audience is
  the most mobile of all. The lean-back TV model is obsolete.
...
- **You are early, and the tools are cheap.** Median keyword competition is low; the seller
  ecosystem is forming now. The surge in "how to sell" queries is your competition arriving -
  but the audience is arriving faster.
...
- **Note the monetisation gap.** Whatnot's enormous, low-ad-cost audience is both an arbitrage
  for marketers and a question for the company's own monetisation - while the clearest B2B
  revenue pool today is the TikTok Shop seller-services ecosystem.
...
| Whatnot monetisation & take-rate | Audience is huge; ad value is low | Evidence it can monetise the audience it already owns |
...
now turns on execution: **supply, trust, and monetisation.** The demand has already inflected;
...
|---|---:|---|
| Curated seeds | ~7,700 | Prior-study seeds + 2026 additions (emerging platforms, verticals) |
